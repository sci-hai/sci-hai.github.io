  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-gray-100">
            ...
            <main className="mx-auto mt-10 max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
              <div className="sm:text-center lg:text-left">
                <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl md:text-6xl">
                  ...
                  <span className="block text-indigo-600 xl:inline">Workshop</span>
                </h1>
                <p className="mt-3 text-base text-gray-500 sm:mx-auto sm:mt-5 sm:max-w-xl sm:text-lg md:mt-5 md:text-xl lg:mx-0">
                  The First Workshop on AI Assisting Scientific Research - exploring the intersection of artificial intelligence and scientific discovery.
                </p>
          ...
          <div className="h-56 w-full bg-indigo-900 sm:h-72 md:h-96 lg:h-full lg:w-full">
            <div className="flex h-full items-center justify-center">
              <div className="p-8 text-center text-white">
                ...
                <div className="text-2xl mb-6">Science & Human-AI Interaction</div>
                <div className="text-xl opacity-80">Date: To be announced</div>
                <div className="text-xl opacity-80">Location: To be announced</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-12 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center">
            <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">About the Workshop</h2>
          ...
          <div className="mt-10">
            ...
            <div className="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg font-medium leading-6 text-gray-900">Idea Generation & Brainstorming</p>
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg font-medium leading-6 text-gray-900">Literature Review & Synthesis</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg font-medium leading-6 text-gray-900">Data Analysis & Discovery</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
              ...
              <div className="relative">
                ...
                <p className="ml-16 text-lg font-medium leading-6 text-gray-900">Research Pipeline Automation</p>
                <p className="mt-2 ml-16 text-base text-gray-500">
      ...
      <div className="bg-gray-50 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="lg:text-center mb-12">
            <h2 className="text-base text-indigo-600 font-semibold tracking-wide uppercase">Our Focus</h2>
            <p className="mt-2 text-3xl leading-8 font-bold tracking-tight text-gray-900 sm:text-4xl">
      ...
      <div className="bg-indigo-700">
        <div className="mx-auto max-w-2xl py-16 px-4 text-center sm:py-20 sm:px-6 lg:px-8">
          ...
          <p className="mt-4 text-lg leading-6 text-indigo-200">
            Submit your research to be part of this exciting workshop exploring the future of
      ...
      <div className="bg-white py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold tracking-tight text-gray-900 mb-12">Schedule Highlights</h2>
          <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 md:rounded-lg mb-10">
            <table className="min-w-full divide-y divide-gray-300">
              <thead className="bg-gray-50">
                <tr>
                  <th scope="col" className="py-3.5 pl-4 pr-3 text-left text-sm font-semibold text-gray-900">Time</th>
                  <th scope="col" className="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Activity</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-gray-200 bg-white">
                <tr>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">09:00 - 10:50</td>
                  <td className="px-3 py-4 text-sm text-gray-500">Keynote Speeches (3 speakers)</td>
                </tr>
                <tr>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">11:05 - 12:00</td>
                  <td className="px-3 py-4 text-sm text-gray-500">Oral Presentations</td>
                </tr>
                <tr>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">13:00 - 14:45</td>
                  <td className="px-3 py-4 text-sm text-gray-500">Keynote Speeches (3 speakers) & Panel Discussion</td>
                </tr>
                <tr>
                  <td className="whitespace-nowrap py-4 pl-4 pr-3 text-sm font-medium text-gray-900">15:30 - 17:00</td>
                  <td className="px-3 py-4 text-sm text-gray-500">Poster Session / Shared Task</td>
                </tr>
              </tbody>
            </table>
          </div>
          <p className="text-center text-gray-500">
            <em>Note: This schedule is tentative and subject to change. See the full schedule for details.</em>
          </p>
          <div className="text-center mt-8">
            <a href="/docs/schedule" className="text-indigo-600 hover:text-indigo-800 font-medium">
      ...
      <div className="bg-gray-50 py-12">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <h2 className="text-center text-3xl font-bold tracking-tight text-gray-900">Important Dates</h2>
          <div className="mt-10">
            <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
              <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm">
                <h3 className="text-lg font-medium text-gray-900">Submission Deadline</h3>
                <div className="mt-2 text-3xl font-bold text-indigo-600">TBA</div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm">
              ...
              <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm">
                <h3 className="text-lg font-medium text-gray-900">Camera-Ready</h3>
                <div className="mt-2 text-3xl font-bold text-indigo-600">TBA</div>
              </div>
              <div className="rounded-lg border border-gray-200 bg-white p-6 text-center shadow-sm">
